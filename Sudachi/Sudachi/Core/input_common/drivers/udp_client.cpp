...
void UDPClient::ReloadSockets() {
    ...
    std::stringstream servers_ss(YuzuSettings::values.udp_input_servers.GetValue());
...
void UDPClient::OnPadData(Response::PadData data, std::size_t client) {
    ...
    for (std::size_t id = 0; id < data.touch.size(); ++id) {
        ...
        const Common::ParamPackage touch_param(YuzuSettings::values.touch_device.GetValue());
...
std::vector<Common::ParamPackage> UDPClient::GetInputDevices() const {
    ...
    if (!YuzuSettings::values.enable_udp_controller) {
        return devices;
    }
    for (std::size_t client = 0; client < clients.size(); client++) {
        if (clients[client].active != 1) {
...
ButtonMapping UDPClient::GetButtonMappingForDevice(const Common::ParamPackage& params) {
    ...
    static constexpr std::array<std::pair<YuzuSettings::NativeButton::Values, PadButton>, 22>
        switch_to_dsu_button = {
            std::pair{YuzuSettings::NativeButton::A, PadButton::Circle},
            {YuzuSettings::NativeButton::B, PadButton::Cross},
            {YuzuSettings::NativeButton::X, PadButton::Triangle},
            {YuzuSettings::NativeButton::Y, PadButton::Square},
            {YuzuSettings::NativeButton::Plus, PadButton::Options},
            {YuzuSettings::NativeButton::Minus, PadButton::Share},
            {YuzuSettings::NativeButton::DLeft, PadButton::Left},
            {YuzuSettings::NativeButton::DUp, PadButton::Up},
            {YuzuSettings::NativeButton::DRight, PadButton::Right},
            {YuzuSettings::NativeButton::DDown, PadButton::Down},
            {YuzuSettings::NativeButton::L, PadButton::L1},
            {YuzuSettings::NativeButton::R, PadButton::R1},
            {YuzuSettings::NativeButton::ZL, PadButton::L2},
            {YuzuSettings::NativeButton::ZR, PadButton::R2},
            {YuzuSettings::NativeButton::SLLeft, PadButton::L2},
            {YuzuSettings::NativeButton::SRLeft, PadButton::R2},
            {YuzuSettings::NativeButton::SLRight, PadButton::L2},
            {YuzuSettings::NativeButton::SRRight, PadButton::R2},
            {YuzuSettings::NativeButton::LStick, PadButton::L3},
            {YuzuSettings::NativeButton::RStick, PadButton::R3},
            {YuzuSettings::NativeButton::Home, PadButton::Home},
            {YuzuSettings::NativeButton::Screenshot, PadButton::TouchHardPress},
        };
...
AnalogMapping UDPClient::GetAnalogMappingForDevice(const Common::ParamPackage& params) {
    ...
    mapping.insert_or_assign(YuzuSettings::NativeAnalog::LStick, std::move(left_analog_params));
    ...
    mapping.insert_or_assign(YuzuSettings::NativeAnalog::RStick, std::move(right_analog_params));
    return mapping;
}
...
MotionMapping UDPClient::GetMotionMappingForDevice(const Common::ParamPackage& params) {
    ...
    mapping.insert_or_assign(YuzuSettings::NativeMotion::MotionLeft, std::move(left_motion_params));
    mapping.insert_or_assign(YuzuSettings::NativeMotion::MotionRight, std::move(right_motion_params));
    return mapping;
}
